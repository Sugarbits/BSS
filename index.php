...
<body>
	<div data-role="page">
		...
		<div data-role="header"><h1>GoodList APP</h1>
		</div>
		...
		<div role="main" class="ui-content">
			<div id="tab1" class="ui-body-d ui-content">
				<h1>歷史紀錄</h1>
					...
					<ul id="history" data-role="listview" data-split-icon="eye" data-split-theme="a" data-inset="true">
						<!--<li><a href="#">
							<b>撰寫中...</b></a>
   ...
   <!--	<ul id="historydetail" data-cnt="0" class="has-del-btns" data-role="listview" data-split-icon="bars" data-split-theme="d">
	</ul> 測試完刪除-->
	<div  data-history="false" data-role="popup" id="purchase" data-theme="none">
		<div data-role="collapsibleset" data-theme="b" data-content-theme="a" data-collapsed-icon="arrow-r" data-expanded-icon="arrow-d" style="margin:0; width:250px;">
			<div id="historydetail-1" data-role="collapsible" data-inset="false">
				<h2>肉品<span class="ui-li-count" >0</span></h2>
				<ul data-role="listview"></ul>
			</div>
			<div id="historydetail-2" data-role="collapsible" data-inset="false">
				<h2>海鮮<span class="ui-li-count" >0</span></h2>
				<ul data-role="listview"></ul>
			</div>
			<div id="historydetail-3" data-role="collapsible" data-inset="false">
				<h2>蔬菜<span class="ui-li-count" >0</span></h2>
				<ul data-role="listview"></ul>
			</div>
			<div id="historydetail-4" data-role="collapsible" data-inset="false">
				<h2>乾貨<span class="ui-li-count" >0</span></h2>
				<ul data-role="listview"></ul>
			</div>
			</div><!-- /collapsible set -->
		</div><!-- /popup -->
			...
			<div id="tab3">
				...
				<div  id="popupSend"  data-history="false"  data-role="popup" data-theme="a" data-overlay-theme="a" class="ui-corner-all">
					<div style="padding:20px 50px;">
						<div style="display:block;"><!--完成後拿掉這一層div隱罩-->
						<h3>清單存檔</h3>
						<p id="popupSendText"></p>
						<div data-role="controlgroup" data-type="horizontal" data-mini="false">
						<label for="text-2-date">日期</label>日期：
						<input type="text" name="text-2-date" id="text-2-date" value="">
...
<script>
   $(window).load(function(){
	eventhandler_history();
	eventhandler_historypopup('purchase');
      eventhandler_radio();
      eventhandler_option();
	  ...
	  eventhandler_popupadd('popupLogin');
   });
</script>